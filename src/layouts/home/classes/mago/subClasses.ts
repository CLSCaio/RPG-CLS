const subClasses = [
  ...
  },
  {
    ...
    <br/><b>Mana:</b> 100 <b>Carga:</b> 1 - 10
    <br/><b>Recarga:</b> 2 turnos
    <br/>Invoca os mortos para lutar ao seu lado, para cada morto-vivo invocado ganha um acumulo de maldição.
    ...
    <br/>Gasta toda a maldição acumulada para invocar o Golem de carne.
    <br/><b> Status morto-vivo: </b>
    <br/> 200 HP | 35 ATK | 20 DEF  
    <br/> 30 SP.DEF | 30 VEL
    <br/><b>OBS: </b> Para cada maldição gasta ganha 2% de bônus nos atributos.
    <br/><b>OBS: </b> Caso gaste o maximo de maldição o bônus será dobrado.
  `,
  },
  {
    title: "Elementalista",
